...
//    
    ...
    if (self.selected) {
        ...
        if (self.indicatorColor) {
            ...
            [[UIColor turquoiseColor] setStroke];
        }
...
// ViewPagerController
@interface CHFViewPagerController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
...
@implementation CHFViewPagerController
