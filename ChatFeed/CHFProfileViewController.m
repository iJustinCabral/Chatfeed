...
- (void)viewDidLoad
{
    ...
    [[ClientManager currentClient] fetchCurrentUserWithCompletion:^(id responseObject, ANKAPIResponseMeta *meta, NSError *error) {
        ...
        NSLog(@"user nil? %@",self.user);
        
        NSString *stringToBeAppendedToUsername = @"@";
        NSMutableAttributedString *attributeString;
        
        if (self.user.verifiedDomain)
        {
         attributeString = [[NSMutableAttributedString alloc] initWithString:self.user.verifiedDomain];
        ...
        NSAttributedString *atribString = [[NSAttributedString alloc] initWithString:@"No Domain" attributes:nil];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            self.verifiedDomainLabel.attributedText = attributeString ? attributeString:atribString;
