...
#pragma mark - NVFacebookTimeAgo Category
...
#pragma mark - TimeAgoTimer Class

@protocol TimeAgoTimerDelegate <NSObject>

- (void)secondDidPass;

@end

@interface TimeAgoTimer : NSObject
+ (instancetype)sharedTimeAgoTimer;
@property (nonatomic, weak) id <TimeAgoTimerDelegate> delegate;
